...
10. Why is media that I have not added to my 'Watchlist' nor my 'Favourites' being added to my 'Real-Debrid' account or not being added at all even though I have it in my lists?
  ...
  - Thirdly, the script does aim to accurately capture a media's name however in cases where media is still yet to be released, be it an original, remake or sequel, a keyword might then lead to a torrent with said kewyord being pulled from the torrent providers site, take for example: 'Trakt' might have movie 'A BC' releasing in two months time but the torrent provider might have movie 'A BC D' already listed on their site and as such, the latter will be pulled and processed due to the keyword 'A BC'.
  - Lastly, the third point should be resolved the moment the media in question is released and a torrent is made available and in the context of the third point, well, as stated, the script should still hopefully be able to pull and process the correct and necessary link.
